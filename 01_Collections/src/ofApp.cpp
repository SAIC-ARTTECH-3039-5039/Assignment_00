...
void ofApp::setup()
{
    ...
    // 1. From the vector, create a map between `name` and `count` (with rank
    // less than 100).

    // Here the "std::string" is the data type of the "key" and "int" is the
    // data type of the "value". A map can be made between almost any pair of
    // data types.
    ...
    // 2. Make a "histogram" of counts by first letter of the surname.
